...
label variable sufitqi  "Mortality rate (per 100,000)"
label variable infitqi  "Mortality rate (per 100,000)"
label variable exfitqi  "Mortality rate (per 100,000)"

*Figure 4.5
twoway (scatter mva internal suicide agecell) (line exfitqi infitqi sufitqi agecell if agecell < 21) ///
                                       (line exfitqi infitqi sufitqi agecell if agecell >= 21), ///
									   legend(off) text(28 20.1 "Motor Vehicle Fatalities") ///
									   text(17 22 "Deaths from Internal Causes") ///
									   text(10.5 22.4 "Suicides")
